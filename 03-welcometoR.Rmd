...
(If nothing happens, make sure that you have enabled pop-ups on your browser, then try it again). Congratulations, you've just run your first code in R.

Now read the code in the console, and follow the instructions to complete your first homework assignment.
...
Get as far as you can, but remember the 15 minute rule.
