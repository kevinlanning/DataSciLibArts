...
Several approaches to graphics (and everything else!) in r; see **syntax cheatsheet** (on Slack)

## logic of ggplot

### the **data visualization cheatsheet** (on Slack)

a layered system of graphics. goal is to come up with some rules for good graphs, and a syntax with which to understand it
