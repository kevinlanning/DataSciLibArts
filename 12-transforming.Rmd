...
## from latitude/longitude to US states

When I first ran this code in 2018, the variables included states and countries.  The current dataset doesn't have these, but it does have longitude and latitude. To get state data from this, reverse  geocoding is needed. A Google search turned up the following. Note that it requires two additional packages
...
So - now you have a list of songs and artists and some measures of "hotttness," restricted to US artists and now including states as well as latitude and longitude.

## exercises
>
>1)  Run the code above, then do something interesting with the data - use filter, arrange, and select in your piped code.
>
>2) Work with the babynames data. Use mutate to create an interesting new variable. 
>
>3) most importantly, make progress on your class project. You will be presenting this two weeks from today.
