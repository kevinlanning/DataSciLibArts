...
On Markdown, see (@freeman2017informatics, Chapter 3). Some Markdown editors include Typora, Atom, and Ghostwriter. There is a simple markdown editor in Slack (for 'posts').

For beginning with R markdown, consider [Carmichael (2017) Getting started](https://idc9.github.io/stor390/notes/getting_started/getting_started.html) as well as the first chapter of @wickham2016r. Install R and R studio on your own laptop.  If you get stuck, reach out to others on Slack; if you don't get stuck, help your classmates.
